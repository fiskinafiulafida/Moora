    ...
    <form action="{{ route('alternatif.update',$alternatif->id) }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="kode" class="form-control" name="kode" id="kode" value="{{ $alternatif->kode }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="nama_alternatif" class="form-control" name="nama_alternatif" id="nama_alternatif" value="{{ $alternatif->nama_alternatif }}">
            </div>

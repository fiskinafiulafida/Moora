...
@section('header')
<h6 class="m-0 font-weight-bold text-primary">Create Data Kriteria</h6>
@endsection
    ...
    <form action="{{ route('kriteria.store') }}" method="POST">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <input type="nama_kriteria" class="form-control @error('nama_kriteria') is-invalid @enderror" name="nama_kriteria" id="nama_kriteria">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="bobot" class="form-control @error('bobot') is-invalid @enderror" name="bobot" id="bobot">
            </div>
            ...
            <div class="row mb-3">
                <div class="col-sm">
                    <select id="jenis_kriteria" class="form-control @error('jenis_kriteria') is-invalid @enderror" id="jenis_kriteria" name="jenis_kriteria" aria-label="Default select example">

...
@section('body')
<div>
    <form action="/subkriteria/{{ $sub->id }}/edit" method="POST">
        @csrf
        <input type="hidden" class="form-control" id="kriteria_id" name="kriteria_id" required value="{{ $sub->kriteria->id }}" />
        <div class="card-body">
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('nama_sub')
                          is-invalid
                      @enderror" id="nama_sub" name="nama_sub" placeholder="" required value="{{ old('nama_sub', $sub->nama_sub) }}" />
                    @error('nama_sub')
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control @error('nilai')
                          is-invalid
                      @enderror" id="nilai" name="nilai" placeholder="" required value="{{ old('nilai', $sub->nilai) }}" />
                    @error('nilai')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
